...
/**
 * Based on the example from issue397: https://github.com/j-easy/easy-random/issues/397
 */
public class RecordFactory extends ObjenesisObjectFactory {
    ...
    private <T> Constructor<T> getCanonicalConstructor(Class<T> recordType) {
        ...
        for (int i = 0; i < recordComponents.length; i++) {
            ...
            // "The components are returned in the same order that they are declared in the record
            // header"
